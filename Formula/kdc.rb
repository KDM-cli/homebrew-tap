class Kdc < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/KDM-cli/kdc-cli/releases/download/v0.1.0/kdc-v0.1.0-aarch64-apple-darwin.tar.gz"
      sha256 "aaa43dbb179010a8a2b2d7160ad46f5da8ccfc85cbeb7a0ac950bc0e0878e68d"
    else
      url "https://github.com/KDM-cli/kdc-cli/releases/download/v0.1.0/kdc-v0.1.0-x86_64-apple-darwin.tar.gz"
      sha256 "ad9ae51e11ed10fdd65dc3ddb1ad93003d8d214736659e68cf33e55fb288b917"
    end
  elsif OS.linux?
    if Hardware::CPU.arm?
      url "https://github.com/KDM-cli/kdc-cli/releases/download/v0.1.0/kdc-v0.1.0-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "23941e122db1a81060847bc65b00b61de72444dfd877a05e91f8c7f013e8fc43"
    else
      url "https://github.com/KDM-cli/kdc-cli/releases/download/v0.1.0/kdc-v0.1.0-x86_64-unknown-linux-gnu.tar.gz"
